...
cat $path/all_facts.lp > $path/all_recette_endophyte.lp
cat $path/all_rules.lp >> $path/all_recette_endophyte.lp

# clingo --enum-mode=brave $path/all_recette_endophyte.lp