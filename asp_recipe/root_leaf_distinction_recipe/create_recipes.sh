...
path_recipe=$path/asp_recipe/root_leaf_distinction_recipe
...
# clingo --enum-mode=brave $path_recipe/recette_endophyte_root.lp > $path/results/root/answers.txt
...
# clingo --enum-mode=brave $path_recipe/recette_endophyte_leaf.lp > $path/results/leaf/answers.txt