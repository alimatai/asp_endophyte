...
parser.add_argument("-f", "--facts", help="table_of_facts_uniprot_2025_01.csv table used for ASP recipe at the models' level (csv table models*EC-PWY)")
parser.add_argument("-l", "--link", help="proteome_tax_id.tsv table from EsMeCaTa output")
parser.add_argument("-o", "--outfile", help="table_of_facts_isolates_uniprot_2025_01.csv")
args = parser.parse_args()

# ../../data/table_of_facts_uniprot_2025_01.csv
# ../../data/proteome_tax_id.tsv
# ../../data/table_of_facts_isolates_uniprot_2025_01.csv
