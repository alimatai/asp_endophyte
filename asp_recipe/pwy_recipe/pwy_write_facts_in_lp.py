...
with open(Path("/home/vmataign/Documents/deepimpact/deepimpact_data/deepimpact_analysis/WP2_analysis/asp_endophyte/asp_recipe/pwy_recipe/pwy_facts.lp"), "w") as lp:

	# Declare EC
	lp.write("% Declare pathways\n\n")
